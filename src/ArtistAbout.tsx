                ...
                <div id="contact" className="grid grid-cols-1 lg:grid-cols-12 gap-16 border-t border-white/10 pt-20 animate-reveal" style={{ animationDelay: "0.7s" }}>
                    ...
                    <form onSubmit={handleSubmit} className="lg:col-span-8 flex flex-col gap-10 w-full">
                        ...
                        <div className="flex justify-end pt-4">
                            <button
                                type="submit"
                                className="w-full md:w-auto px-10 py-3.5 bg-[#c8a96e] text-[#0a0a0a] font-outfit font-normal text-xs tracking-[0.25em] uppercase transition-all duration-300 hover:bg-[#d4b87a] active:scale-[0.98] cursor-pointer border-none"
                            >
                                Send Message
                            </button>
                        </div>
